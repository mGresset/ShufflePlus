...
const CACHE_VERSION = "shuffleplus-v9.9.28";
...
const OPTIONAL_APP_SHELL = [
    "./app-health.js",
    "./styles/feature-home.css?v=9.9.28",
    "./universal-search.js",
    "./styles/feature-search.css?v=9.9.28",
    "./styles/feature-settings.css?v=9.9.28",
    "./styles/feature-driving.css?v=9.9.28",
    "./favicon.ico",
    "./icons/icon-192.png",
    "./icons/icon-512.png",
