...
test("les métadonnées de distribution annoncent la v8.3.0", () => {
    assert.equal(versionSource, "8.3.0");
    assert.match(packageSource, /"version": "8\.3\.0"/);
    assert.match(indexSource, /shuffleplus-version" content="8\.3\.0/);
    assert.match(indexSource, /startup-recovery-8\.3\.0\.js/);
});
