...
test("les métadonnées de distribution annoncent la v9.9.35", () => {
    assert.equal(versionSource, "9.9.35");
    assert.match(packageSource, /"version": "9\.9\.35"/);
    assert.match(indexSource, /shuffleplus-version" content="9\.9\.35/);
    assert.match(indexSource, /startup-recovery-9\.9\.35\.js/);
});
