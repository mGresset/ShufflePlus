...
test("les métadonnées de distribution annoncent la v10.1.0", () => {
    assert.equal(versionSource, "10.1.0");
    assert.match(packageSource, /"version": "10\.1\.0"/);
    assert.match(indexSource, /shuffleplus-version" content="10\.1\.0/);
