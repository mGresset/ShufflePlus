...
test("Shuffle+ 10.7.0 force une découverte Spotify Connect fraîche pour les raccourcis", () => {
...
test("Shuffle+ 10.7.0 récupère aussi le device actif depuis l'état de lecture", () => {
