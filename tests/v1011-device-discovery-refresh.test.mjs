...
test("Shuffle+ 10.1.1 force une découverte Spotify Connect fraîche pour les raccourcis", () => {
...
test("Shuffle+ 10.1.1 récupère aussi le device actif depuis l'état de lecture", () => {
