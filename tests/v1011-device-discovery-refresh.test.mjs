...
test("Shuffle+ 10.6.0 force une découverte Spotify Connect fraîche pour les raccourcis", () => {
...
test("Shuffle+ 10.6.0 récupère aussi le device actif depuis l'état de lecture", () => {
