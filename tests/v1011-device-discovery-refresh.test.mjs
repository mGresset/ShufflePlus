...
test("Shuffle+ 10.1.4 force une découverte Spotify Connect fraîche pour les raccourcis", () => {
...
test("Shuffle+ 10.1.4 récupère aussi le device actif depuis l'état de lecture", () => {
