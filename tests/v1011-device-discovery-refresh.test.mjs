...
test("Shuffle+ 10.1.3 force une découverte Spotify Connect fraîche pour les raccourcis", () => {
...
test("Shuffle+ 10.1.3 récupère aussi le device actif depuis l'état de lecture", () => {
