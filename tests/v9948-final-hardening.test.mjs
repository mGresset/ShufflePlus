...
const [
    ...
    readFile(new URL("../bootstrap-11.0.0.js", import.meta.url), "utf8"),
...
test("11.0.0 limite la réparation PWA au scope Shuffle+ exact", () => {
...
test("11.0.0 borne connect-src aux services réellement utilisés", () => {
