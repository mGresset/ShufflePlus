...
const [
    ...
    readFile(new URL("../bootstrap-10.1.3.js", import.meta.url), "utf8"),
    readFile(new URL("../startup-recovery-10.1.3.js", import.meta.url), "utf8"),
...
test("10.1.3 limite la réparation PWA au scope Shuffle+ exact", () => {
...
test("10.1.3 borne connect-src aux services réellement utilisés", () => {
...
test("le mode conduite et le manifeste n'accumulent plus les anciens patchs", () => {
    assert.match(drivingCss, /v10\.1\.3 — contrat mobile conduite consolidé/);
