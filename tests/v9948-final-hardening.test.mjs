...
const [
    ...
    readFile(new URL("../bootstrap-10.8.0.js", import.meta.url), "utf8"),
    readFile(new URL("../startup-recovery-10.8.0.js", import.meta.url), "utf8"),
...
test("10.8.0 limite la réparation PWA au scope Shuffle+ exact", () => {
...
test("10.8.0 borne connect-src aux services réellement utilisés", () => {
