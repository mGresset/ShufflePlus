...
const [
    ...
    readFile(new URL("../startup-recovery-9.9.48.js", import.meta.url), "utf8"),
...
test("9.9.48 limite la réparation PWA au scope Shuffle+ exact", () => {
...
test("9.9.48 borne connect-src aux services réellement utilisés", () => {
...
test("le mode conduite et le manifeste n'accumulent plus les anciens patchs", () => {
    assert.match(drivingCss, /v9\.9\.48 — contrat mobile conduite consolidé/);
