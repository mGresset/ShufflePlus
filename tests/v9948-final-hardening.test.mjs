...
const [
    ...
    readFile(new URL("../bootstrap-10.5.1.js", import.meta.url), "utf8"),
    readFile(new URL("../startup-recovery-10.5.1.js", import.meta.url), "utf8"),
...
test("10.5.1 limite la réparation PWA au scope Shuffle+ exact", () => {
...
test("10.5.1 borne connect-src aux services réellement utilisés", () => {
