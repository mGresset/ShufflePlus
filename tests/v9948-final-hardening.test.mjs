...
const [
    ...
    readFile(new URL("../bootstrap-9.9.49.js", import.meta.url), "utf8"),
    readFile(new URL("../startup-recovery-9.9.49.js", import.meta.url), "utf8"),
...
test("9.9.49 limite la réparation PWA au scope Shuffle+ exact", () => {
...
test("9.9.49 borne connect-src aux services réellement utilisés", () => {
...
test("le mode conduite et le manifeste n'accumulent plus les anciens patchs", () => {
    assert.match(drivingCss, /v9\.9\.49 — contrat mobile conduite consolidé/);
