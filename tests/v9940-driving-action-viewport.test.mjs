...
<<<<<<< HEAD
test("Shuffle+ 9.9.48 conserve le viewport stable pendant une commande conduite", () => {
    assert.equal(version, "9.9.48");
=======
test("Shuffle+ 9.9.47 conserve le viewport stable pendant une commande conduite", () => {
