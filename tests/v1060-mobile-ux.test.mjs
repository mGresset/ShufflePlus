...
test("Shuffle+ 10.8.0 charge une couche UX mobile globale après le design system", () => {
    assert.equal(version, "10.8.0");
    const designIndex = indexSource.indexOf("design-system.css?v=10.8.0");
    const mobileIndex = indexSource.indexOf("mobile-ux.css?v=10.8.0");
    ...
    assert.match(workerSource, /\.\/mobile-ux\.css\?v=10\.8\.0/);
});
