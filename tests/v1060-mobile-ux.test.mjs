...
test("Shuffle+ 11.0.0 charge une couche UX mobile globale après le design system", () => {
    assert.equal(version, "11.0.0");
    const designIndex = indexSource.indexOf("design-system.css?v=11.0.0");
    const mobileIndex = indexSource.indexOf("mobile-ux.css?v=11.0.0");
    ...
    assert.match(workerSource, /\.\/mobile-ux\.css\?v=11\.0\.0/);
});
