...
test("l’harmonisation desktop active annonce Shuffle+ 9.9.27", () => {
    assert.equal(version, "9.9.27");
    assert.match(indexSource, /design-system\.css\?v=9\.9\.27/);
    assert.match(indexSource, /bootstrap-9\.9\.27\.js/);
});
