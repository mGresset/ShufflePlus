...
test("l’harmonisation desktop active annonce Shuffle+ 9.9.21", () => {
    assert.equal(version, "9.9.21");
    assert.match(indexSource, /design-system\.css\?v=9\.9\.21/);
    assert.match(indexSource, /bootstrap-9\.9\.21\.js/);
});
