...
test("l’harmonisation desktop active annonce Shuffle+ 10.5.0", () => {
    assert.equal(version, "10.5.0");
    assert.match(indexSource, /design-system\.css\?v=10\.5\.0/);
    assert.match(indexSource, /bootstrap-10\.5\.0\.js/);
});
