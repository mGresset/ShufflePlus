...
test("l’harmonisation desktop active annonce Shuffle+ 10.9.0", () => {
    assert.equal(version, "10.9.0");
    assert.match(indexSource, /design-system\.css\?v=10\.9\.0/);
    assert.match(indexSource, /bootstrap-10\.9\.0\.js/);
});
