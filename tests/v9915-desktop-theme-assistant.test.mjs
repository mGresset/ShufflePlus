...
test("l’harmonisation desktop active annonce Shuffle+ 9.9.19", () => {
    assert.equal(version, "9.9.19");
    assert.match(indexSource, /design-system\.css\?v=9\.9\.19/);
    assert.match(indexSource, /bootstrap-9\.9\.19\.js/);
});
