...
test("l’harmonisation desktop active annonce Shuffle+ 10.1.1", () => {
    assert.equal(version, "10.1.1");
    assert.match(indexSource, /design-system\.css\?v=10\.1\.1/);
    assert.match(indexSource, /bootstrap-10\.1\.1\.js/);
});
