...
test("11.0.0 protège le callback Spotify avant toute purge PKCE", () => {
...
test("11.0.0 bloque une deuxième réparation après le reload", () => {
...
test("11.0.0 court-circuite la deuxième migration bootstrap", () => {
...
test("11.0.0 garde le verrou jusqu’à la stabilité du runtime", () => {
