...
test("10.5.2 protège le callback Spotify avant toute purge PKCE", () => {
...
test("10.5.2 bloque une deuxième réparation après le reload", () => {
...
test("10.5.2 court-circuite la deuxième migration bootstrap", () => {
...
test("10.5.2 garde le verrou jusqu’à la stabilité du runtime", () => {
