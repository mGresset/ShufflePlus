...
test("10.1.3 protège le callback Spotify avant toute purge PKCE", () => {
...
test("10.1.3 bloque une deuxième réparation après le reload", () => {
...
test("10.1.3 court-circuite la deuxième migration bootstrap", () => {
...
test("10.1.3 garde le verrou jusqu’à la stabilité du runtime", () => {
