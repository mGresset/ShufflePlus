...
test("10.4.0 protège le callback Spotify avant toute purge PKCE", () => {
...
test("10.4.0 bloque une deuxième réparation après le reload", () => {
...
test("10.4.0 court-circuite la deuxième migration bootstrap", () => {
...
test("10.4.0 garde le verrou jusqu’à la stabilité du runtime", () => {
