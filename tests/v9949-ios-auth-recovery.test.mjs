...
test("9.9.49 protège le callback Spotify avant toute purge PKCE", () => {
...
test("9.9.49 bloque une deuxième réparation après le reload", () => {
...
test("9.9.49 court-circuite la deuxième migration bootstrap", () => {
...
test("9.9.49 garde le verrou jusqu’à la stabilité du runtime", () => {
