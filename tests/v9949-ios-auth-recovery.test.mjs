...
test("10.5.1 protège le callback Spotify avant toute purge PKCE", () => {
...
test("10.5.1 bloque une deuxième réparation après le reload", () => {
...
test("10.5.1 court-circuite la deuxième migration bootstrap", () => {
...
test("10.5.1 garde le verrou jusqu’à la stabilité du runtime", () => {
