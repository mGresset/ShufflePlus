...
> **État du projet :** la branche `9.9.x` est une candidate de finalisation avant la v10. La version actuelle est **9.9.25**.
...
npm.cmd run validate
git add -A
git commit -m "Release Shuffle+ v9.9.25"
...
3. vérifier que l’en-tête affiche **v9.9.25** ;
...
bootstrap-9.9.25.js        Chargement versionné et migration du runtime
startup-recovery-9.9.25.js Réparation avant le chargement principal
...
- `V9.9.25_NOTES.md` : changements propres à la version actuelle ;
- `DEPLOIEMENT-V9.9.25.md` : procédure courte de publication ;
- `INSTALLATION-V9.9.25.txt` : rappel d’installation ;
