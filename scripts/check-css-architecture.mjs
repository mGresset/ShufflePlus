...
if (!settings.includes("Shuffle+ v10.6.0 — Expérience Essentiel / Expert")) {
    failures.push("feature-settings.css ne contient pas le contrat Essentiel/Expert v10.6.0");
}
