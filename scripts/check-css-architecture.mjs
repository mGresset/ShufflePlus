...
if (!settings.includes("Shuffle+ v10.5.1 — Expérience Essentiel / Expert")) {
    failures.push("feature-settings.css ne contient pas le contrat Essentiel/Expert v10.5.1");
}
